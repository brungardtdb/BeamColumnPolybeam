...
namespace BeamColumnPolybeam.Modeler_Classes.Abstract_Classes
{
    public abstract class PolyBeamModeler
    {
        // fields for PolyBeamModeler class
        protected Model classModel; // tekla model we will be working in
        protected PolyBeam classBeam; // beam we will be modeling
        
        protected PolyBeamModeler()
        {
